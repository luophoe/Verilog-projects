...
2. Verify the RTL model by entering this command with Incisive: 

irun mux.v mux_test.v 

or this command with Xcelium:
xrun mux.v mux_test.v 
...
6. Verify the gate-level model with Incisive; enter: 

irun mux.vg mux_test.v -v ../sources/tutorial.v -vlogext vg 

or this command with Xcelium:
xrun mux.vg mux_test.v -v ../sources/tutorial.v -vlogext vg 

You should see TEST PASSED with similar results. 

7. Again verify the RTL model with Incisive, but this time enter:
