...
The VeriRISC CPU contains an accumulator register and an instruction register. One generic register definition can serve both purposes. On the active-high clock edge the register value becomes zero if the “rst” input is true and
...
3. Using the provided test module, test your register description with
Incisive, enter: 
