...
3. Verify the RTL model(s) by entering this command with Incisive: 
...
xrun lib.v lib_test.v -define macro 
...
5. Verify the gate-level models by entering this command with Incisive: 
...
or this command with Xcelium:
xrun *.vg lib_test.v -v ../sources/tutorial.v -vlogext vg -define macro 
