...
2. Simulate the RTL design and test; enter this command with Incisive: 
...
4. Simulate the gate-level design and test by entering this command with
Incisive: 
...
a. Enter this command with Incisive: 
